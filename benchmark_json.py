...
# Replicate the data structure from simple_seismic_server.py
SYSTEM_METRICS = {
...
def run_benchmark():
    ...
    print(f"Payload Size (indent=2): {size_indent} bytes")
    print(f"Payload Size (separators): {size_separators} bytes")
    reduction = (size_indent - size_separators) / size_indent * 100
    ...
    print(f"indent=2: {time_indent:.4f} s")
    print(f"separators: {time_separators:.4f} s")
